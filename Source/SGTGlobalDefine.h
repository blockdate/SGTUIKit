...
#define SIZE_TextSmall                          10.0
#define SIZE_TextContentNormal                  13.0
#define SIZE_TextTitleMini                      15.0
#define SIZE_TextTitleNormal                    17.0
#define SIZE_TextLarge                          16.0
#define SIZE_TextHuge                           18.0


#define SystemColor [UIColor redColor]
#define LineColor RGBColor(232, 234, 234)
#define SGTWhiteColor [UIColor whiteColor]
#define SGTClearColor [UIColor clearColor]
#define SGTLightBGColor [UIColor colorWithWhite:0.937 alpha:1.000]
...
#ifndef SGTSYNTH_DYNAMIC_PROPERTY_OBJECT
#define SGTSYNTH_DYNAMIC_PROPERTY_OBJECT(_getter_, _setter_, _association_, _type_) \
