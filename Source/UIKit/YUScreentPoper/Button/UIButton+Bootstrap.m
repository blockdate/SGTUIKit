...
-(void)purpleStyle{
    ...
    self.layer.borderColor = [[UIColor colorWithRed:212/255.0 green:63/255.0 blue:58/255.0 alpha:1] CGColor];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:210/255.0 green:230/255.0 blue:51/255.0 alpha:1]] forState:UIControlStateHighlighted];

}

-(void)cancelStyle{
    //133,140,150
    self.backgroundColor =  [UIColor colorWithRed:133/255.0 green:140/255.0 blue:150/255.0 alpha:1];
