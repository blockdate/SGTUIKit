...
/**
 @author block, 16-05-19 15:05:27
 
 @brief Add a Button with a title,a command
 
 @param title   The text displayed on the button.
 @param command the command execute on click
...
@property(copy, nonatomic) SCLAlertViewBuilder *(^addButtonWithCommand)(NSString *title,RACCommand *command);
