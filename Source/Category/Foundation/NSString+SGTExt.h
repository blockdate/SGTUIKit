 ...
 *  @return 返回对应的Size
 */
- (CGSize)sizeToFont:(nonnull UIFont *)font WithWidth:(CGFloat)width;
 ...
 *  @return 返回对应的Size
 */
- (CGSize)sizeToFont:(nonnull UIFont *)font WithWidth:(CGFloat)width lineWith:(CGFloat)lineWidth;
...
/**
 *  is the selfString belong to Chinese
 *
 *  @return yes/no
 */
-(BOOL)isChinese;
 ...
 */
- (CGSize)sizeForFont:(nonnull UIFont *)font size:(CGSize)size mode:(NSLineBreakMode)lineBreakMode;
 ...
 */
- (CGFloat)widthForFont:(nonnull UIFont *)font;
 ...
 */
- (CGFloat)heightForFont:(nonnull UIFont *)font width:(CGFloat)width;
 ...
 */
- (BOOL)matchesRegex:(nullable NSString *)regex options:(NSRegularExpressionOptions)options;
 ...
 */
- (void)enumerateRegexMatches:(nullable NSString *)regex
...
//加密
- (nullable NSString *) desEncryptKey:(nullable NSString *)key;
- (nullable NSString *) desDecryptKey:(nullable NSString *)key;
//+ (nullable NSData *)DESEncrypt:(nullable NSData *)data WithKey:(nullable NSString *)key;
//解密
